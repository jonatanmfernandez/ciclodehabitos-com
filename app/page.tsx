...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      {/* 1. Hero Section */}
      <section className="relative py-20 md:py-32 overflow-hidden bg-white border-b border-slate-200">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-100/50 via-slate-50 to-white -z-10" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-slate-900 tracking-tight mb-6 leading-tight">
              Tus hábitos no fallan por falta de <span className="text-blue-600">voluntad.</span><br />
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 text-center">
                <div className="text-3xl font-black text-blue-600 mb-1">2K+</div>
      ...
      {/* 2. Sobre El Blog */}
      <section id="sobre" className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-[1fr_2fr] gap-16">
            <div className="relative">
              <div className="sticky top-24">
                <div className="text-xs font-bold tracking-widest text-blue-600 uppercase mb-4">Acerca del blog</div>
                <h2 className="text-4xl font-bold text-slate-900 mb-6 leading-tight">La ciencia del comportamiento, <span className="text-blue-600">sin filtro.</span></h2>
            ...
            <div className="prose prose-slate prose-lg max-w-none text-slate-600 font-light leading-relaxed">
              <h3 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-3">
                <span className="w-8 h-1 bg-blue-600 rounded-full"></span> ¿Qué es Ciclo de Hábitos?
              </h3>
              <p>
              ...
              <p className="font-semibold text-slate-900">El problema nunca fue el esfuerzo. Fue el diseño.</p>
              
              <div className="my-8 p-8 bg-white shadow-sm border border-slate-100 rounded-2xl text-slate-800">
      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Qué encontrarás <span className="text-blue-600">aquí</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Ciencia traducida, no resumida</h3>
              <p className="text-slate-600 font-light leading-relaxed">Cada artículo cita investigación real con autor, institución y año. Nunca "estudios muestran". Siempre la fuente, siempre la traducción práctica. La ciencia del comportamiento es accesible — solo hay que explicarla bien.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
              <div className="w-16 h-16 bg-orange-100 text-orange-600 rounded-2xl flex items-center justify-center text-3xl mb-6">🧭</div>
              <h3 className="text-xl font-bold text-slate-900 mb-4">Mitos desmontados, sin piedad</h3>
              <p className="text-slate-600 font-light leading-relaxed">Los 21 días para formar un hábito. La fuerza de voluntad como virtud moral. El poder del pensamiento positivo. Cada creencia popular sobre el cambio de comportamiento sometida al escrutinio de la evidencia.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
              <div className="w-16 h-16 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center text-3xl mb-6">⚙️</div>
              <h3 className="text-xl font-bold text-slate-900 mb-4">Sistemas, no propósitos</h3>
              <p className="text-slate-600 font-light leading-relaxed">La diferencia entre querer hacer algo y hacerlo sistemáticamente es el diseño. Aquí encontrarás marcos concretos para construir sistemas de hábitos, gestión del tiempo y toma de decisiones.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <div className="text-xs font-bold tracking-widest text-blue-600 uppercase mb-4">Por qué la ciencia importa</div>
              <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">El cambio real viene de entender tu cerebro, <span className="text-blue-600">no de forzarlo.</span></h2>
              <p className="text-lg text-slate-600 mb-4 font-light leading-relaxed">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center font-black text-xl shrink-0">01</div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1">Neurociencia aplicada</h4>
                    <p className="text-slate-600 text-sm">Cómo los ganglios basales graban y ejecutan patrones automáticamente.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center font-black text-xl shrink-0">02</div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1">Psicología del comportamiento</h4>
                    <p className="text-slate-600 text-sm">Sesgos cognitivos, bucles de hábito y arquitectura de decisiones.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center font-black text-xl shrink-0">03</div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-1">Diseño de entorno</h4>
                    <p className="text-slate-600 text-sm">Cómo tu contexto determina tu comportamiento — y cómo modificarlo.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-slate-50 border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-16 leading-tight">
            ...
            <span className="text-blue-600">merece honestidad,</span> no esperanza.
          </h2>
      ...
      {/* 7. Newsletter */}
      <section id="newsletter" className="py-32 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
            Una idea de ciencia. <br/> <span className="text-blue-600">Cada martes.</span>
          </h2>
