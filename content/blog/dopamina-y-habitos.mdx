...
{/* JSON-LD removed from inline MDX to avoid next-mdx-remote compile errors.
  If you want structured data, add it via the page layout or Next.js Head component. */}
